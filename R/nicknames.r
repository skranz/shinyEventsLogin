nick.names.list = function() {
	# list are copied from DOCKER, see
  ...
  left = c(
    ...
    # Added some economics nobel laurates... since, well I am an economist
    "Tinbergen",
    "Frisch",
    "Samuelson",
    "Kuznets",
...
#' nickname list is copied from DOCKER
#' @param n number of names to create
#' @export
random.nickname = function(n=1) {
  li = nick.names.list()
  tolower(paste0(sample(li$left,n),"_", sample(li$right,n)))
}

examples.random.nickname = function() {
  random.nickname()
}

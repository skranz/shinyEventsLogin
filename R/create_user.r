...
create.user.in.db = function(conn=dbConnect(db.arg$drv, db.arg$dbname), userid, email=userid, password, db.arg=list(dbname=paste0(db.dir,"/",dbname),drv=drv), dbname="userDB.sqlite",drv=SQLite(), db.dir="") {
